...
<body>
	<h1>This is Academic Time Edit Page</h1>
	<form:form
		action="${pageContext.request.contextPath }/academic/new.html"
		method="POST" modelAttribute="Academictime">
		<center>
			...
			<tr>
				...
				<tr>
					<td><s:message code="Term2 EndtDate" /></td>
